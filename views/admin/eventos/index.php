...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton" href="/admin/eventos/crear"><i class="fa-solid fa-circle-plus"></i>Agregar Evento</a>
</div>
                    ...
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            ...
                            <form method="POST" action="/admin/eventos/eliminar" class="table__formulario">
                                ...
                                <button class="table__accion table__accion--eliminar" type="submit"><i class="fa-solid fa-trash"></i>Eliminar</button>
                            </form>
                        </td>
                    </tr>
